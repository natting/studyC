...
int testInput_1_1[8] = { 101, 100, 50, 30, 101, 100, 101, 100 }; // TODO: 항목 1-1 테스트 입력을 추가하시오.
int testInput_1_2[8] = { 101, 101, 100, 50, 30, 50, 100, 101 }; // TODO: 항목 1-2 테스트 입력을 추가하시오.
int testInput_1_3[8] = { 101, 101, 100, 50, 30, 50, 101, 101}; // TODO: 항목 1-3 테스트 입력을 추가하시오.
...
void test_2_1()
{
	// 미세먼지 단계가 (매우나쁨/매우나쁨/나쁨/보통/나쁨/나쁨/나쁨) 순으로 7개가 감지되는 경우를 재현하는 코드를 작성하라.
...
{
	// TODO: 항목 2-2. 
	// 세 먼지 단계가 (매우나쁨/나쁨/나쁨/매우나쁨/나쁨/좋음/나쁨/매우나쁨/나쁨/매우나쁨/나쁨) 순으로 
	// 11개가 감지되는 경우를 재현하는 코드를 작성하라.
	int tmp[] = {101, 100, 100, 101, 100, 30, 100, 101, 100, 101, 100};	// TODO: 항목 2-1. 
	int i;
	index = 0;
	tmpCurrentPM = tmp;
	for (i = 0; i < 11; i++) {
